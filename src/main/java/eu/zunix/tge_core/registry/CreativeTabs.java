...
public final class CreativeTabs {
    private static final DeferredRegister<CreativeModeTab> TABS =
            DeferredRegister.create(net.minecraft.core.registries.Registries.CREATIVE_MODE_TAB, TGECore.MOD_ID);
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TOOLS = TABS.register(
            ...
            () -> CreativeModeTab.builder()
                    ...
                    .icon(() -> Tools.entries().getFirst().item().get().getDefaultInstance())
                    .displayItems((parameters, output) ->
                            Tools.entries().forEach(tool -> output.accept(tool.item().get())))
                    .build());
