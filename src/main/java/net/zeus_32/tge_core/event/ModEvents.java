package net.zeus_32.tge_core.event;
...
import net.zeus_32.tge_core.item.custom.MiningHammerItem;

import java.util.HashSet;
import java.util.Set;

@EventBusSubscriber(modid = TGECore.MODID, bus = EventBusSubscriber.Bus.GAME)
